...
//	gi.sound (self, CHAN_VOICE, sound_attack2, 1, ATTN_NORM, 0);
	/*void monster_fire_bfg (edict_t *self,
							 ...
							 float damage_radius,
							 int flashtype)*/
	monster_fire_bfg (self, start, dir, damage, 400 + 20 * self->monsterinfo.skill, 100, 200 + 3 * self->monsterinfo.skill, MZ2_JORG_BFG_1);
}
...
void jorg_firebullet_right (edict_t *self)
{
	...
	VectorMA (self->enemy->s.origin, -(0.3 - 0.008 * self->monsterinfo.skill), self->enemy->velocity, target);
